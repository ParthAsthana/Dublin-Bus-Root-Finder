...
//     Pehla wala is checking if the next  node has been visited
// Second checking agar current to next edge hai
// Third agar current ki distance from source is not 9999
// Fourth agar current distance + current to next distance is less than next distance
